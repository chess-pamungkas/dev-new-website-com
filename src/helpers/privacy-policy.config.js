...
const PRIVACY_POLICY_CONTENT = [
  ...
  },
  {
    ...
    subItems: [
      {
        text: "In order to receive more information, register for a demo account, open a trading account with us or for any other business relationship, you are requested to complete the Application Form. By completing the Application Form and providing your personal information, you enable us to evaluate the application and comply with laws and regulations governing the provision of financial services. The same information will be used by the Company to contact you regarding the offered services.",
      },
      {
      ...
      {
        text: "The Company is obligated by the regulations of Cyprus Securities and Exchange Commission to keep your Personal Data on record for a period of five years which is calculated after the execution of the transactions or the termination of the business relationship or even longer if it is requested by the CySEC.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subItems: [
      {
        text: "Any personal information is treated as confidential and may be shared within the Company and its partners to meet its contractual and legal obligations. Contractual relationships exist with the Company’s partners aiming to safeguard the Client’s personal data in accordance with the Data Protection Legislation. Our company partners maintain the privacy of your information to the same extent the Company does in accordance with the policy. Non- affiliated companies that assist the Company in providing services to you are required to maintain the confidentiality of such information and to use your personal information only in the course of providing such services for the purposes that the Company dictates and within the ambit of the applicable law.",
      },
      {
        ...
        subItems: [
          ...
          {
            text: "• Data Protection Officer of the Company who may be outsourced;",
          },
        ],
      },
    ],
  ...
  {
    title: "Transfer Personal Data outside the European Economic Area",
    subItems: [
      {
        text: "The Company’s aim is to safeguard Personal Data when these are to be transferred outside the European Economic Area. According to GDPR, Personal Data can be transferred outside the European Economic Area if adequate protective measures established.",
      },
      {
        text: "The Company takes appropriate protective measures if Personal Data are disclosed to a third party. The third parties that the Company may transmit Personal Data shall comply with the GDPR or the equivalent legislation of their home member state.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subItems: [
      {
        text: "The privacy and confidentiality of your personal information is of fundamental importance to us. We take all appropriate security measures to protect against unauthorised access to or unauthorised alteration, disclosure or destruction of data and personal information.",
      },
      {
  ...
  {
    title: "Changes of Privacy Policy",
    subItems: [
      {
        text: "The Company reserves the right to change or amend the Privacy policy without further notice to you, provided that the changes do not significantly reduce your rights under this Policy. If we make material changes to this policy, we will notify you by email or by means of a notice on our home page or by changing the version of the document including the date of the update which will be visible to the first page of this document. The latest and prevailing version of this Policy will at all times be available at www.oqtima.eu . Any revised Policy will be effective immediately upon posting on our Web Site.",
      },
    ],
  },
  {
...
const PRIVACY_POLICY_CONTENT_FSA = [
  // FYI: There is no need to translate this text into other languages, so we don't need to store it in locales.
  {
    ...
    subItems: [
      ...
      {
        text: "1.6 We observe the principles of legality, propriety, necessity, and sincerity when we are collecting and/or handling your personal information. We will not handle your personal information in any way that is misleading, swindling, coercive or other such ways.",
      },
      {
        text: "1.7 Your personal and/or sensitive information may be used by us to administer and market our products and services, for prudential and risk management purposes and, unless you tell us otherwise, to provide you with related marketing information. We also use the information we hold to help detect and prevent illegal activity. We cooperate with police and other enforcement bodies as required or allowed by law.",
      },
      {
        text: "1.8 We disclose relevant personal information to external organizations that help us provide services. These organizations are bound by confidentiality arrangements. They may include overseas organizations.",
      },
      {
        text: "1.9 You can seek access to and/or make a copy of the personal information we hold about you. If the information we hold about you is inaccurate, incomplete, or outdated, please inform us so that we can correct it.",
      },
      {
        text: "1.10 Aggregated data is general data about groups of people which doesn’t identify anyone personally (e.g., the number of people in a particular industry that engage in forex trading). We may share aggregated data with our business or industry partners. We may use the aggregated data to help us to:",
        subItems: [
          {
            text: "(a) to understand how you use our products and services and improve your experience with us; and",
          },
          {
            text: "(b) customize the way that we communicate with you about our products and services so that we can interact with you more effectively.",
          },
        ],
      },
      {
        text: "1.11 We keep this Policy under regular review and may update it from time to time to reflect changes in the law and/or our privacy practices. We encourage you to check the date of this Policy for any updates or changes when you visit our website or use our services. Any modified versions of this Policy may materially affect the way we use or disclose your personal information.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        text: "2.1 We collect personal information when it is reasonably necessary for one or more of our functions or activities in providing our services to you. These include:",
        subItems: [
          {
            text: "(a) providing customers with the products and services they request and, unless they tell us otherwise, to provide information on products and services offered by us and external product and service providers for whom we act as agent (that may be of interest to you).(If you have provided us with your email or mobile phone details, we may provide information to you electronically with respect to those products and services);",
          },
          {
            text: "(b) complying with our legal and regulatory obligations;",
          },
          {
            text: "(c) monitoring and evaluating products and services;",
          },
          {
            text: "(d) monitor compliance with our regulatory obligations;",
          },
          {
            text: "(e) gathering and aggregating information for statistical, prudential, actuarial and research purpose;",
          },
          {
            text: "(f) assisting customers with queries and any concerns you raise against us and/or to manage any legal action; and",
          },
          {
            text: "(g) taking measures to detect and prevent fraud, unlawful activity, or misconduct.",
          },
        ],
      },
    ],
    ...
    subItems: [
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            text: "(c) company directors and officers;",
          },
          {
            text: "(d) officers of co-operatives and associations;",
          },
          {
            text: "(e) customer’s agents;",
          },
          {
            text: "(f) beneficial owners of a client; and",
          },
          {
            text: "(g) persons dealing with us on a “one-off” basis.",
          },
        ],
      },
      {
        text: "3.4 We may take steps to verify the information we collect; for example, a birth certificate provided as identification may be verified with records held by the Registry of Births, Deaths and Marriages to protect against impersonation.",
      },
    ],
  },
  {
    title: "4. Inform you before obtaining consent",
    subItems: [
      {
        text: "4.1 We will, before obtaining your consent and collecting personal information, explicitly inform you truthfully, accurately, and fully of the following items using clear and easily understood language:",
        subItems: [
          {
            text: "(a) The name and contact method of the personal information handler;",
          },
          {
            text: "(b) The purpose of personal information processing and the processing methods, the categories of processed personal information, the legal basis for the processing and the storage period;",
          },
          {
            text: "(c) The recipients or categories of recipients of the personal data, if any;",
          },
          {
            text: "(d) Where applicable, the fact that personal data is to be transferred to a third country or international organization, we will ensure that we have adopted the appropriate safeguards; and",
          },
          {
            text: "(e) Other information necessary to ensure fair and transparent processing.",
          },
        ],
      },
    ],
  },
  {
    ...
    subItems: [
      {
        text: "5.1 We only collect personal information subject to your consent. The consent must be voluntarily given, and we ensure that we do not force, pressure, induce or manipulate you into providing consent, neither will we elicit consent by asking leading questions.",
      },
      {
        text: "5.2 When assessing whether consent is freely given, utmost account shall be taken of whether, inter alia, the performance of a contract, including the provision of a service, is conditional on consent to the processing of personal information that is not necessary for the performance of that contract.",
      },
      {
        text: "5.3 We will provide clear, reasonably understandable, and full information to you of the specific purpose of obtaining consent.",
      },
      {
        text: "5.4 You shall have the right to withdraw your consent at any time by contacting us at support@oqtima.com. We provide a convenient and easy way for you to withdraw consent. If you rescind consent, it does not affect the effectiveness of personal information handling activities undertaken on the basis of individual consent before consent was withdrawn.",
      },
      {
        text: "5.5 If your consent is given in the context of a written declaration which also concerns other matters, we will present the request for consent in a manner which is clearly distinguishable from the other matters, in an intelligible and easily accessible form, using clear and plain language.",
      },
      {
        text: "5.6 Where a change occurs in the purpose of personal information handling, the handling method, or the categories of handled personal information, the data subject’s consent shall be obtained again.",
      },
    ],
  },
  {
    title: "6. How we collect the information",
    subItems: [
      {
        text: "6.1 We only collect personal information about you directly from you unless it is unreasonable or impracticable to do so or you have instructed us to liaise with someone else.",
      },
      {
        text: "6.2 Your personal data will be collected in a way that is adequate, relevant, and limited to what is necessary in relation to the purpose for which the personal information is processed.",
      },
      {
        text: "6.3 We may, within a reasonable scope, handle personal information that has already been disclosed by yourself or otherwise lawfully disclosed, except where you clearly refuse.",
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            text: "(b) requiring our staff to use passwords when accessing our systems;",
          },
          {
            text: "(c) employing firewalls, intrusion detection systems, virtual private networks (VPNs), encryption, and virus scanning tools to protect against unauthorized persons and viruses from entering our systems;",
          },
          {
            text: "(d) using dedicated secure networks or encryption when we transmit electronic data for purposes of outsourcing;",
          },
          {
            text: "(e) providing secure storage for physical records; and",
          },
          {
            text: "(f) employing physical and electronic means such as alarms, cameras and guards (as required) to protect against unauthorized access to buildings.",
          },
        ],
      },
      {
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) you would reasonably expect us to use or disclose the information for the secondary purpose and the secondary purpose is: a) if the information is sensitive - directly related to the primary purpose; or b) if the information is not sensitive - related to the primary purpose;",
          },
          {
            text: "(c) the use or disclosure of the information is required or authorized by or under a local law or a court/tribunal order or other applicable laws and regulations; or",
          },
          {
            text: "(d) a permitted general situation exists in relation to the use or disclosure of the information by us; or",
          },
          {
            text: "(e) a permitted health situation exists in relation to the use or disclosure of the information by us, in which case we will de-identify the information before disclosing it; or",
          },
          {
            text: "(f) we reasonably believe that the use or disclosure of the information is reasonably necessary for one or more enforcement related activities conducted by, or on behalf of, an enforcement body; or",
          },
        ],
      },
      {
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) affiliated product and service providers and external product and service providers for whom we act as agent (so that they may provide you with the product or service you seek or in which you have expressed an interest);",
          },
          {
            text: "(c) auditors we appoint to ensure the integrity of our operations;",
          },
          {
            text: "(d) any person acting on your behalf, including your solicitor, settlement agent, accountant, executor, administrator, trustee, guardian or attorney;",
          },
          {
            text: "(e) your referee (to confirm details about you);",
          },
          {
            text: "(f) if required or authorized to do so, regulatory bodies, law enforcement bodies, courts and government agencies;",
          },
          {
            text: "(g) credit reporting agencies;",
          },
          {
            text: "(h) insurers, including proposed insurers and insurance reference agencies (where we are considering whether to accept a proposal of insurance from you and, if so, on what terms);",
          },
          {
            text: "(i) medical practitioners (to verify or clarify, if necessary, any health information you may provide);",
          },
          {
            text: "(j) other financial institutions and organizations at their request if you seek credit from them (so that they may assess whether to offer you credit);",
          },
          {
            text: "(k) investors, advisers, trustees and ratings agencies where credit facilities and receivables are pooled and sold (securitized);",
          },
          {
            text: "(l) other organizations who in conjunction with us provide products and services (so that they may provide their products and services to you) including organizations involved in managing payments such as banks; and",
          },
          {
            text: "(m) professional associations or organizations with whom we conduct an affinity relationship (to verify your membership of those associations or organizations).",
          },
        ],
      },
      {
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) you will be able to access to take action to enforce the protection of a law or binding scheme that has the effect of protecting the information in a way that is at least substantially similar to the way in which the Seychelles privacy laws or other applicable laws and regulations protect the information; or",
          },
          {
            text: "(c) you have consented to the disclosure after we expressly informed you that there is no guarantee that the overseas recipient will not breach the Seychelles privacy laws and regulations or other applicable laws and regulations; or",
          },
          {
            text: "(d) the disclosure of the information is required or authorized by or under a Seychelles law or other applicable laws and regulations or a court/tribunal order; or",
          },
          {
            text: "(e) other permitted general situation under the Seychelles laws and regulations or other applicable laws and regulations in relation to the disclosure of the information.",
          },
          {
            text: "(f) The sharing of the data is lawful;",
          },
          {
            text: "(g) the processing only takes place in jurisdictions that have been found to uphold an adequate level of protection regarding personal data.",
          },
        ],
      },
    ],
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) reasonably necessary for us to fulfil its obligations to a government agency or authority; or",
          },
          {
            text: "(c) required or authorized by or under the Seychelles law, regulation, or a court/tribunal order; or",
          },
          {
            text: "(d) within a permitted general situation under the Seychelles laws and regulations; or",
          },
          {
            text: "(e) reasonably necessary for one or more enforcement related activities conducted by, or on behalf of, an enforcement body.",
          },
        ],
      },
    ],
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) you withdraw consent on which the using of personal information is based and where there is no other legal ground for the using (i.e., the provision of products or services); or",
          },
          {
            text: "(c) the personal information has been unlawfully used.",
          },
        ],
      },
      {
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) It is likely to result in serious harm to one or more individuals; and",
          },
          {
            text: "(c) We haven’t been able to prevent the likely risk of serious harm with remedial action.",
          },
        ],
      },
    ],
    ...
    subItems: [
      {
        ...
        subItems: [
          ...
          {
            text: "(b) Post: Postal Address: F20, 1st Floor, Eden Plaza, Eden Island, Seychelles",
          },
        ],
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      {
        text: "33.3 To assist us in helping you, we ask you to follow a simple three-step process:",
        subItems: [
          {
            text: "(a) Gather all supporting documents relating to the complaint.",
          },
          {
            text: "(b) Contact us and we will review your situation and if possible, resolve your complaint immediately.",
          },
          {
            text: "(c) If the matter is not resolved to your satisfaction, please contact our Complaint’s Officer via email at complaints@oqtima.com or put your complaint in writing and send it to the Company’s address above.",
          },
        ],
      },
      {
        text: "33.4 We may need to verify your identity. The Company will acknowledge your complaint within seven (7) days and we will respond promptly to it. After a thorough investigation, we will take a decision on the matter and inform you accordingly.",
      },
    ],
  },
  {

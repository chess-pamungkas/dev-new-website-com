...
export const PROMO_INTERSECTION_RATIO_TO_SCROLL_LG = 0.25;
export const PROMO_INTERSECTION_RATIO_TO_REVERSE_LG = 0.45;

// export const PROMO_INTERSECTION_RATIO_TO_SCROLL_LG = 0.15;
// export const PROMO_INTERSECTION_RATIO_TO_REVERSE_LG = 0.35;

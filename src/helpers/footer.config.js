...
import { PROFESSIONAL_QUALIFICATION_PAGE_LINK } from "./constants";
...
export const FOOTER_COPYRIGHT = {
  ...
  p4: "footer-copyright-paragraph4",
  a2: "footer-copyright-paragraph-link-2",
  link2: PROFESSIONAL_QUALIFICATION_PAGE_LINK,
};

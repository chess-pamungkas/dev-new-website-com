import privacyPolicyFSA from "../assets/documents/fsa/Privacy_Policy.pdf";
import clientCategorisationNoticeFSA from "../assets/documents/fsa/Client_Categorisation_Notice.pdf";
import complaintHandlingPolicyFSA from "../assets/documents/fsa/Complaint_Handling_Policy.pdf";
import conflictOfInterestPolicyFSA from "../assets/documents/fsa/Conflict_of_Interest_Policy.pdf";
import termsAndConditionsFSA from "../assets/documents/fsa/Terms_and_Conditions.pdf";
import investorCompensationFundFSA from "../assets/documents/fsa/Investor_Compensation_Fund-1.pdf";
import orderExecutionPolicyFSA from "../assets/documents/fsa/Order_Execution_Policy.pdf";
import riskDisclosureFSA from "../assets/documents/fsa/Risk_Disclosure.pdf";
import keyInformationFXFSA from "../assets/documents/fsa/Key_Information_Document_FX.pdf";
import keyInformationIndicesFSA from "../assets/documents/fsa/Key_Information_Document_Indices.pdf";
import keyInformationCommoditiesFSA from "../assets/documents/fsa/Key_Information_commo.pdf";
import summaryStatementFSA from "../assets/documents/fsa/Summary Statement.pdf";
import disciplineReportFSA from "../assets/documents/fsa/Disclosure_and_Market_Discipline_Report_Pillar_III_2021.pdf";
...
export const LEGAL_DOCS_FSA = [
  {
    name: "document-client-categorisation-notice-name",
    file: clientCategorisationNoticeFSA,
    // TODO replace with the real data
    date: "09/05/2022",
  },
  {
  ...
  {
    name: "document-conflict-of-interest-name",
    file: conflictOfInterestPolicyFSA,
    date: "09/05/2022",
  },
  {
    name: "document-terms-and-cond-name",
    file: termsAndConditionsFSA,
    date: "09/05/2022",
  },
  {
    name: "document-investor-compensation-fund-name",
    file: investorCompensationFundFSA,
    date: "09/05/2022",
  },
  {
    name: "document-order-execution-name",
    file: orderExecutionPolicyFSA,
    date: "09/05/2022",
  },
  {
    name: "document-privacy-policy-name",
  ...
  {
    name: "document-risk-disclosure-name",
    file: riskDisclosureFSA,
    date: "09/05/2022",
  },
  {
    name: "document-key-FX-name",
    file: keyInformationFXFSA,
    date: "09/05/2022",
  },
  {
    name: "document-key-indices-name",
    file: keyInformationIndicesFSA,
    date: "09/05/2022",
  },
  {
    name: "document-key-commodities-name",
    file: keyInformationCommoditiesFSA,
    date: "09/05/2022",
  },
  {
    name: "document-summary-statement-name",
    file: summaryStatementFSA,
    date: "09/05/2022",
  },
  {
    name: "document-discipline-report-name",
    file: disciplineReportFSA,
    date: "09/05/2022",
  },
];

export const RISK_DISCLOSURE_DOC_FSA = riskDisclosureFSA;
